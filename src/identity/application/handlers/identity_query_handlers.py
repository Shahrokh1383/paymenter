...
class GetAllUsersHandler:
    def __init__(self, user_repo: UserRepository): self._repo = user_repo
    def handle(self, query: GetAllUsersQuery) -> List[Any]: return self._repo.get_all_summaries()

class SearchUsersHandler:
    def __init__(self, user_repo: UserRepository): self._repo = user_repo
    def handle(self, query: SearchUsersQuery) -> List[Any]: return self._repo.search_summaries(query.query)
